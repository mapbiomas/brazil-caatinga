...
var imgMapCol8V4 =  ee.ImageCollection(param.asset_filted.V4).max()
                                .select(banda_activa).remap(param.classMapB, param.classNew);
var imgMapCol8V5 =  ee.ImageCollection(param.asset_filted.V5).max()
                                .select(banda_activa).remap(param.classMapB, param.classNew);
var imgMapCol8V6 =  ee.ImageCollection(param.asset_filted.V6).max()
                                .select(banda_activa).remap(param.classMapB, param.classNew);
// var imgMapCol8V7 =  ee.ImageCollection(param.asset_filted.V7).max()
//                                 .select(banda_activa).remap(param.classMapB, param.classNew);
// var imgMapCol8V8 =  ee.ImageCollection(param.asset_filted.V8).max()
//                                 .select(banda_activa).remap(param.classMapB, param.classNew);
// var imgMapCol8V9 =  ee.ImageCollection(param.asset_filted.V9).max()
//                                 .select(banda_activa).remap(param.classMapB, param.classNew);
var imgMapCol8V10 =  ee.ImageCollection(param.asset_filted.V10).max()
                                .select(banda_activa).remap(param.classMapB, param.classNew);                          
...
// print("imagem no Asset Geral X Bacias col 8", imgMapCol8V7);
...
Map.addLayer(imgMapCol8V4,  visualizar.visclassCC, 'Col8_ClassV4');
Map.addLayer(imgMapCol8V5,  visualizar.visclassCC, 'Col8_ClassV5');
Map.addLayer(imgMapCol8V6,  visualizar.visclassCC, 'Col8_ClassV6');
// Map.addLayer(imgMapCol8V7,  visualizar.visclassCC, 'Col8_ClassV7');
// Map.addLayer(imgMapCol8V8,  visualizar.visclassCC, 'Col8_ClassV8');
