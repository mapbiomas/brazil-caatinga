//https://code.earthengine.google.com/28c8ad7063968d60b4472123bb0635fb
var featuresreduce = [
    ...
    'evi2_median_wet', 'evi2_amp', 'evi2_stdDev', 'savi_median_dry', 'gcvi_median_dry', 
    'slope'
]
...
var exportMapMaskAfloramento = function(imgYear, nameExp, geometria){   
    var outputAsset = 'projects/mapbiomas-workspace/AMOSTRAS/col8/CAATINGA/AFLORAMENTO' + '/' + nameExp;
    var optExp = {   
        'image': imgYear.byte(), 
        'description': nameExp, 
        'assetId': outputAsset, 
...
var asset_limCaatiga = 'users/CartasSol/shapes/nCaatingaBff3000';
...
var limitCaatinga = ee.FeatureCollection(asset_limCaatiga);
...
exportMapMaskAfloramento(maskAflora, "label_mask_afloramento", limitCaatinga);
