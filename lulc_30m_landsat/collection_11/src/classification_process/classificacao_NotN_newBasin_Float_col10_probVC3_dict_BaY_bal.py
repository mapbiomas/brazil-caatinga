...
class ClassMosaic_indexs_Spectral(object):
    ...
    def down_samples_ROIs(self, rois_train, nbacia):
        ...
        dictQtLimit_v1 = {
            '3': 750, '4': 2000, '12': 50, '15': 1500,
            '19': 120, '21': 220, '22': 220, '29': 50,
            '33': 70, '36': 120
        }
        ...
        for nyear in self.lst_year[:]:  # 
            ...
            if nyear in lista_years:                
                ...
                if nyear < 2026:
                    ...
                    nameFeatROIs =  f"rois_fromBasin_{dict_rois_viz[_nbacia]}_{nyear}"
                else:
...
dict_bacias_process = {
    ...
    "7712": [
        "1989","1993","1995","1998","1999", "2001", "2002"
    ],
    "7616": ["1988"],
    "7618": ["1985", "1988", "1991", "1995"],
    "761111": ["1986", "1988", "2013"],
    "7592": ["1985", "1986", "1994"],
}
# '7617', '7564',  '763', '7622'
...
# sys.exit()
for _nbacia in list(dict_bacias_process.keys())[:]:
    if knowMapSaved:
        try:
        ...
        lst_years = [int(yyear) for yyear in dict_bacias_process[_nbacia]]
        print(f" ---- {len(lst_years)} years to processing ")
        # print(lst_years)
