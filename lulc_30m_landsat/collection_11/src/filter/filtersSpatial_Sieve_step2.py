...
param = {
    'output_asset': 'projects/mapbiomas-workspace/AMOSTRAS/col11/CAATINGA/POS-CLASS/Spatials_sieve',
    ...
    'native_scale':      30,     # resolução Landsat (m)
    'max_filter_pixels': 25,     # manchas com cc ≤ este valor são substituídas
