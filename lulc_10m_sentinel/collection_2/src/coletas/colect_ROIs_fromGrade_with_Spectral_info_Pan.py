...
class ClassMosaic_indexs_Spectral(object):
    ...
    options = {
        ...
        'asset_output': 'projects/mapbiomas-workspace/AMOSTRAS/col9/PANTANAL/SAMPLES_GRID',
    ...
    def agregateBandsTexturasGLCM(self, img):        
        ...
        contrastnirDry = textura2Dry.select('nir_median_dry_contrast').toFloat()
        #
...
cc = 0
# sys.exit()
for item in range(gradeInic, gradeEnd):
