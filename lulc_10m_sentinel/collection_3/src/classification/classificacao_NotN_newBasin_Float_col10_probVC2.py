...
class ClassMosaic_indexs_Spectral(object):
    ...
    options = {
        ...
        'asset_ROIs_merge': 'projects/mapbiomas-workspace/AMOSTRAS/col10/CAATINGA/S2/ROIs/ROIs_merged_Indall_v3_clean',
    ...
    def iterate_bacias(self, _nbacia, makeProb):        
        ...
        for nyear in self.lst_year[:]:
            ...
            ROIs_toTrain = self.convert_distribuition_ideal(ROIs_toTrain)
